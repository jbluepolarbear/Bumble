...
class BumbleImage {
    ...
    setSize(width, height) {
        this.__transformation.scale.x = width / this.image.width;
        this.__transformation.scale.y = height / this.image.height;
    }
...
class BumbleShape {
    constructor(bumble, points, color, fill = true) {
        ...
        this.__width = 0;
        this.__height = 0;
        this.__transformation = new BumbleTransformation(this.__bumble, this.__width, this.__height);
        this.__transformation.position = new BumbleVector();
        this.__transformation.rotation = 0.0;
        this.__transformation.anchor = new BumbleVector(0.5, 0.5);
        this.__transformation.scale = new BumbleVector(1.0, 1.0);
        ...
        this.__transformation.width = this.__width;
        this.__transformation.height = this.__height;
    }
